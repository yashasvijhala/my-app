      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            >
              <span className="font-medium text-blue-600">SK5</span> Buisness
              Solutions
            </motion.div>

            <p className="text-gray-600 mb-6 max-w-md">
              Innovative business solutions to help your company thrive in the
              digital age. We combine cutting-edge technology with strategic
        ...
        <div className="mt-12 pt-8 border-t border-gray-100">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Nova Solutions. All rights reserved.
            </p>
